...
var Inflector = {
  ...
  foreignKey: function(str, dropIdUbar) {
    str = Inflector.underscore(Inflector.demodulize(str)) + (dropIdUbar ? "" : "_") + "id";
    return str;
  },
  /**
...
var index_default = Inflector;
var pluralize = Inflector.pluralize;
var singularize = Inflector.singularize;
var camelize = Inflector.camelize;
var underscore = Inflector.underscore;
var humanize = Inflector.humanize;
var capitalize = Inflector.capitalize;
var dasherize = Inflector.dasherize;
var camel2words = Inflector.camel2words;
var demodulize = Inflector.demodulize;
var tableize = Inflector.tableize;
var classify = Inflector.classify;
var foreignKey = Inflector.foreignKey;
var ordinalize = Inflector.ordinalize;
