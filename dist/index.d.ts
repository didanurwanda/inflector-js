...
const underscore = Inflector.underscore;
const humanize = Inflector.humanize;
const capitalize = Inflector.capitalize;
const dasherize = Inflector.dasherize;
const camel2words = Inflector.camel2words;
const demodulize = Inflector.demodulize;
const tableize = Inflector.tableize;
const classify = Inflector.classify;
const foreignKey = Inflector.foreignKey;
const ordinalize = Inflector.ordinalize;

export { camel2words, camelize, capitalize, classify, dasherize, Inflector as default, demodulize, foreignKey, humanize, ordinalize, pluralize, singularize, tableize, underscore };
